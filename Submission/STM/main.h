...
#define SERVO_TURN_TIME 300 //300

#define SERVO_LEFT_MAX 85
#define SERVO_CENTER 145
#define SERVO_RIGHT_MAX 207 //210

#define IR_CONST_A_R -63.19418
#define IR_CONST_B_R 3374.48016
#define IR_CONST_A_L -60.70204
#define IR_CONST_B_L 3284.49452
#define IR_SAMPLE 5
...
#define DUTY_SP1_RANGE 700 //700

#define INIT_DUTY_SP2_L 3000
#define INIT_DUTY_SP2_R 3000
#define DUTY_SP2_RANGE 700 //700

#define INIT_DUTY_SP3_L 4500
#define INIT_DUTY_SP3_R 4500
#define DUTY_SP3_RANGE 800 //800

#define MIN_SPEED_SCALE 0.4 // INIT_DUTY_SP1_L / INIT_DUTY_SP2_L

//#define SERVO_TURN_TIME 500 //300

#define __GET_TARGETTICK(dist, targetTick) ({                         \
  targetTick = (((dist)*DIST_M - DIST_C) / WHEEL_LENGTH * 1360); \
}) //-10 at the back
