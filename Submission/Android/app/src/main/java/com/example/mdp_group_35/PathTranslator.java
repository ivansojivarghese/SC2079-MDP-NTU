...
//                gridMap.setCurCoord(curX, curY, dir);
    ...
    public void translatePath(String stmCommand) {
        Log.d(TAG, "translatePath: " + stmCommand);
        showLog("Entered translatePath");
        ...
        if(stmCommand.contains("MOVE") || stmCommand.contains("FW") || stmCommand.contains("BW")){
            Log.d(TAG, "entered if: " + stmCommand);
...
//            } catch(Exception e) {}
            ...
            String direction = stmCommand.substring(0, 2); // Extracts "FW"
            commandValue = Integer.parseInt(stmCommand.substring(2)); // Extracts "010" as 10
...
//showLog(String.valueOf(Integer.parseInt(stmCommand.split(",")[2])));
        ...
        else if (stmCommand.contains("TURN") || stmCommand.contains("FR") || stmCommand.contains("BR") || stmCommand.contains("FL") || stmCommand.contains("BL")){
            // String direction = stmCommand.split(",")[1];
            //set commandType for <DIRECTION> for Turns

            Log.d(TAG, "Entered else if: " + stmCommand);
            String direction = stmCommand.substring(0, 2); // Extracts "FW"

            if(direction.equals("FC") || direction.equals("FR")){
                commandType = 'd';
            }
            if(direction.equals("FA") || direction.equals("FL")){
                commandType = 'a';
            }
            if (direction.equals("BA") || direction.equals("BR")){
                commandType = 'e';
            }
            if (direction.equals("BC") || direction.equals("BL")){
                commandType = 'q';
            }
        }
