...
//        updateButton = root.findViewById(R.id.updateMapBtn);
        ...
        gyroSwitch = root.findViewById(R.id.gyroSwitch);
...
//        });
        ...
        resetMapBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // Clear grid map
                Home.printMessage(Target.RPI, "CLEAR");
                gridMap.resetMap();
...
//                        gridMap.setObstacleCoord(Integer.parseInt(coords[0]) + 1, Integer.parseInt(coords[1]) + 1, "","");
                        ...
                        gridMap.setObstacleCoord(Integer.parseInt(coords[0]) + 1, Integer.parseInt(coords[1]) + 1, direction);
                        try {
                            Thread.sleep(50);
