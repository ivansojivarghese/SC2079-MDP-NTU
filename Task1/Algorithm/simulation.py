...
class Simulation():
    ...
    def turnRight(self, gridSize, cellSize):
        if self.currentPos[2] == Direction.TOP:
            if (0 <= (self.currentPos[0] - (constants.TURN_MED_FORWARD_RIGHT_TOP[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + constants.TURN_MED_FORWARD_RIGHT_TOP[0] // 10) * cellSize < gridSize):
                ...
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_MED_FORWARD_RIGHT_TOP[1] // 10), self.currentPos[1] + (constants.TURN_MED_FORWARD_RIGHT_TOP[0] // 10), Direction.RIGHT)
        elif self.currentPos[2] == Direction.RIGHT:
            if (0 <= (self.currentPos[0] - (constants.TURN_MED_FORWARD_RIGHT_RIGHT[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + constants.TURN_MED_FORWARD_RIGHT_RIGHT[0] // 10) * cellSize < gridSize):
                ...
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_MED_FORWARD_RIGHT_RIGHT[1] // 10), self.currentPos[1] + (constants.TURN_MED_FORWARD_RIGHT_RIGHT[0] // 10), Direction.BOTTOM)
        elif self.currentPos[2] == Direction.BOTTOM:
            if (0 <= (self.currentPos[0] - (constants.TURN_MED_FORWARD_RIGHT_BOTTOM[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] - (constants.TURN_MED_FORWARD_RIGHT_RIGHT[0] // 10)) * cellSize < gridSize):
                ...
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_MED_FORWARD_RIGHT_BOTTOM[1] // 10), self.currentPos[1] + (constants.TURN_MED_FORWARD_RIGHT_BOTTOM[0] // 10), Direction.LEFT)
        elif self.currentPos[2] == Direction.LEFT:
            if (0 <= (self.currentPos[0] - (constants.TURN_MED_FORWARD_RIGHT_LEFT[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_MED_FORWARD_RIGHT_LEFT[0] // 10)) * cellSize < gridSize):
                ...
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_MED_FORWARD_RIGHT_LEFT[1] // 10), self.currentPos[1] + (constants.TURN_MED_FORWARD_RIGHT_LEFT[0] // 10), Direction.TOP)

    def turnLeft(self, gridSize, cellSize):
        if self.currentPos[2] == Direction.TOP:
            if (0 <= (self.currentPos[0] - (constants.TURN_MED_FORWARD_LEFT_TOP[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_MED_FORWARD_LEFT_TOP[0] // 10)) * cellSize < gridSize):
                # for x in range(self.currentPos[0] - 3, self.currentPos[0] + 2):
                #     for y in range(self.currentPos[1] - 4, self.currentPos[1] + 2):
                #         if (x > self.currentPos[0] - 3) and (y < self.currentPos[1] - 1):
                #             continue
                ...
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_MED_FORWARD_LEFT_TOP[1] // 10), self.currentPos[1] + (constants.TURN_MED_FORWARD_LEFT_TOP[0] // 10), Direction.LEFT)
        elif self.currentPos[2] == Direction.RIGHT:
            if (0 <= (self.currentPos[0] - (constants.TURN_MED_FORWARD_LEFT_RIGHT[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_MED_FORWARD_LEFT_RIGHT[0] // 10)) * cellSize < gridSize):
                # for x in range(self.currentPos[0] - 4, self.currentPos[0] + 2):
                #     for y in range(self.currentPos[1] - 1, self.currentPos[1] + 4):
                #         if (x < self.currentPos[0] - 1) and (y < self.currentPos[1] + 3):
                #             continue
                ...
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_MED_FORWARD_LEFT_RIGHT[1] // 10), self.currentPos[1] + (constants.TURN_MED_FORWARD_LEFT_RIGHT[0] // 10), Direction.TOP)
        elif self.currentPos[2] == Direction.BOTTOM:
            if (0 <= (self.currentPos[0] - (constants.TURN_MED_FORWARD_LEFT_BOTTOM[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_MED_FORWARD_LEFT_BOTTOM[0] // 10)) * cellSize < gridSize):
                # for x in range(self.currentPos[0] - 1, self.currentPos[0] + 4):
                #     for y in range(self.currentPos[1] - 1, self.currentPos[1] + 5):
                #         if (x < self.currentPos[0] + 3) and (y > self.currentPos[1] + 1):
                #             continue
                ...
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_MED_FORWARD_LEFT_BOTTOM[1] // 10), self.currentPos[1] + (constants.TURN_MED_FORWARD_LEFT_BOTTOM[0] // 10), Direction.RIGHT)
        elif self.currentPos[2] == Direction.LEFT:
            if (0 <= (self.currentPos[0] - (constants.TURN_MED_FORWARD_LEFT_LEFT[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_MED_FORWARD_LEFT_LEFT[0] // 10)) * cellSize < gridSize):
                # for x in range(self.currentPos[0] - 1, self.currentPos[0] + 5):
                #     for y in range(self.currentPos[1] - 3, self.currentPos[1] + 2):
                #         if (x > self.currentPos[0] + 1) and (y > self.currentPos[1] - 3):
                #             continue
                ...
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_MED_FORWARD_LEFT_LEFT[1] // 10), self.currentPos[1] + (constants.TURN_MED_FORWARD_LEFT_LEFT[0] // 10), Direction.BOTTOM)

    def reverseTurnRight(self, gridSize, cellSize):
        if self.currentPos[2] == Direction.TOP:
            if (0 <= (self.currentPos[0] - (constants.TURN_MED_REVERSE_RIGHT_TOP[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_MED_REVERSE_RIGHT_TOP[0] // 10)) * cellSize < gridSize):
                # for x in range(self.currentPos[0] - 1, self.currentPos[0] + 5):
                #     for y in range(self.currentPos[1] - 1, self.currentPos[1] + 4):
                ...
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_MED_REVERSE_RIGHT_TOP[1] // 10), self.currentPos[1] + (constants.TURN_MED_REVERSE_RIGHT_TOP[0] // 10), Direction.LEFT)
        elif self.currentPos[2] == Direction.RIGHT:
            if (0 <= (self.currentPos[0] - (constants.TURN_MED_REVERSE_RIGHT_RIGHT[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_MED_REVERSE_RIGHT_RIGHT[0] // 10)) * cellSize < gridSize):
                # for x in range(self.currentPos[0] - 1, self.currentPos[0] + 4):
                #     for y in range(self.currentPos[1] - 4, self.currentPos[1] + 2):
                ...
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_MED_REVERSE_RIGHT_RIGHT[1] // 10), self.currentPos[1] + (constants.TURN_MED_REVERSE_RIGHT_RIGHT[0] // 10), Direction.TOP)
        elif self.currentPos[2] == Direction.BOTTOM:
            if (0 <= (self.currentPos[0] - (constants.TURN_MED_REVERSE_RIGHT_BOTTOM[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_MED_REVERSE_RIGHT_BOTTOM[0] // 10)) * cellSize < gridSize):
                # for x in range(self.currentPos[0] - 4, self.currentPos[0] + 2):
                #     for y in range(self.currentPos[1] - 3, self.currentPos[1] + 2):
                #         if (x > self.currentPos[0] - 2) and (y < self.currentPos[1] - 1):
                #             continue
                ...
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_MED_REVERSE_RIGHT_BOTTOM[1] // 10), self.currentPos[1] + (constants.TURN_MED_REVERSE_RIGHT_BOTTOM[0] // 10), Direction.RIGHT)
        elif self.currentPos[2] == Direction.LEFT:
            if (0 <= (self.currentPos[0] - (constants.TURN_MED_REVERSE_RIGHT_LEFT[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_MED_REVERSE_RIGHT_LEFT[0] // 10)) * cellSize < gridSize):
                # for x in range(self.currentPos[0] - 3, self.currentPos[0] + 2):
                #     for y in range(self.currentPos[1] - 1, self.currentPos[1] + 5):
                #         if (x < self.currentPos[0] - 1) and (y < self.currentPos[1] + 2):
                #             continue
                ...
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_MED_REVERSE_RIGHT_LEFT[1] // 10), self.currentPos[1] + (constants.TURN_MED_REVERSE_RIGHT_LEFT[0] // 10), Direction.BOTTOM)

    def reverseTurnLeft(self, gridSize, cellSize):
        if self.currentPos[2] == Direction.TOP:
            if (0 <= (self.currentPos[0] - (constants.TURN_MED_REVERSE_LEFT_TOP[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_MED_REVERSE_LEFT_TOP[0] // 10)) * cellSize < gridSize):
                # for x in range(self.currentPos[0] - 1, self.currentPos[0] + 5):
                #     for y in range(self.currentPos[1] - 3, self.currentPos[1] + 2):
                #         if (x < self.currentPos[0] + 2) and (y < self.currentPos[1] - 1):
                #             continue
                ...
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_MED_REVERSE_LEFT_TOP[1] // 10), self.currentPos[1] + (constants.TURN_MED_REVERSE_LEFT_TOP[0] // 10), Direction.RIGHT)
        elif self.currentPos[2] == Direction.RIGHT:
            if (0 <= (self.currentPos[0] - (constants.TURN_MED_REVERSE_LEFT_RIGHT[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_MED_REVERSE_LEFT_RIGHT[0] // 10)) * cellSize < gridSize):
                # for x in range(self.currentPos[0] - 3, self.currentPos[0] + 2):
                #     for y in range(self.currentPos[1] - 4, self.currentPos[1] + 2):
                #         if (x < self.currentPos[0] - 1) and (y > self.currentPos[1] - 2):
                #             continue
                ...
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_MED_REVERSE_LEFT_RIGHT[1] // 10), self.currentPos[1] + (constants.TURN_MED_REVERSE_LEFT_RIGHT[0] // 10), Direction.BOTTOM)
        elif self.currentPos[2] == Direction.BOTTOM:
            if (0 <= (self.currentPos[0] - (constants.TURN_MED_REVERSE_LEFT_BOTTOM[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_MED_REVERSE_LEFT_BOTTOM[0] // 10)) * cellSize < gridSize):
                # for x in range(self.currentPos[0] - 4, self.currentPos[0] + 2):
                #     for y in range(self.currentPos[1] - 1, self.currentPos[1] + 4):
                #         if (x > self.currentPos[0] - 2) and (y > self.currentPos[1] + 1):
                #             continue
                ...
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_MED_REVERSE_LEFT_BOTTOM[1] // 10), self.currentPos[1] + (constants.TURN_MED_REVERSE_LEFT_BOTTOM[0] // 10), Direction.LEFT)
        elif self.currentPos[2] == Direction.LEFT:
            if (0 <= (self.currentPos[0] - (constants.TURN_MED_REVERSE_LEFT_LEFT[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_MED_REVERSE_LEFT_LEFT[0] // 10)) * cellSize < gridSize):
                # for x in range(self.currentPos[0] - 1, self.currentPos[0] + 4):
                #     for y in range(self.currentPos[1] - 1, self.currentPos[1] + 5):
                #         if (x > self.currentPos[0] + 1) and (y < self.currentPos[1] + 2):
                #             continue
                ...
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_MED_REVERSE_LEFT_LEFT[1] // 10), self.currentPos[1] + (constants.TURN_MED_REVERSE_LEFT_LEFT[0] // 10), Direction.TOP)
    ...
    def moveNorthEast(self, gridSize, cellSize):
        if self.currentPos[2] == Direction.TOP:
            ...
            #             print(f"COLLISION!")
            #             return
            if (0 <= (self.currentPos[0] - (constants.TURN_SMALL_FORWARD_RIGHT_TOP[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_SMALL_FORWARD_RIGHT_TOP[0] // 10)) * cellSize < gridSize):
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_SMALL_FORWARD_RIGHT_TOP[1] // 10), self.currentPos[1] + (constants.TURN_SMALL_FORWARD_RIGHT_TOP[0] // 10), self.currentPos[2])
        elif self.currentPos[2] == Direction.RIGHT:
            # for y in range(self.currentPos[1] - 1, self.currentPos[1] + 2):
            #     for obstacle in self.obstacles:
            #         i = (constants.GRID_LENGTH - constants.GRID_CELL_LENGTH - obstacle.position.x) // constants.GRID_CELL_LENGTH
            ...
            #             print(f"COLLISION!")
            #             return
            if (0 <= (self.currentPos[0] - (constants.TURN_SMALL_FORWARD_RIGHT_RIGHT[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_SMALL_FORWARD_RIGHT_RIGHT[0] // 10)) * cellSize < gridSize):
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_SMALL_FORWARD_RIGHT_RIGHT[1] // 10), self.currentPos[1] + (constants.TURN_SMALL_FORWARD_RIGHT_RIGHT[0] // 10), self.currentPos[2])
        elif self.currentPos[2] == Direction.BOTTOM:
            # for y in range(self.currentPos[1] - 1, self.currentPos[1] + 2):
            #     for obstacle in self.obstacles:
            #         i = (constants.GRID_LENGTH - constants.GRID_CELL_LENGTH - obstacle.position.x) // constants.GRID_CELL_LENGTH
            ...
            #             print(f"COLLISION!")
            #             return
            if (0 <= (self.currentPos[0] - (constants.TURN_SMALL_FORWARD_RIGHT_BOTTOM[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_SMALL_FORWARD_RIGHT_BOTTOM[0] // 10)) * cellSize < gridSize):
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_SMALL_FORWARD_RIGHT_BOTTOM[1] // 10), self.currentPos[1] + (constants.TURN_SMALL_FORWARD_RIGHT_BOTTOM[0] // 10), self.currentPos[2])
        elif self.currentPos[2] == Direction.LEFT:
            # for y in range(self.currentPos[1] - 1, self.currentPos[1] + 2):
            #     for obstacle in self.obstacles:
            #         i = (constants.GRID_LENGTH - constants.GRID_CELL_LENGTH - obstacle.position.x) // constants.GRID_CELL_LENGTH
            ...
            #             print(f"COLLISION!")
            #             return
            if (0 <= (self.currentPos[0] - (constants.TURN_SMALL_FORWARD_RIGHT_LEFT[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_SMALL_FORWARD_RIGHT_LEFT[0] // 10)) * cellSize < gridSize):
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_SMALL_FORWARD_RIGHT_LEFT[1] // 10), self.currentPos[1] + (constants.TURN_SMALL_FORWARD_RIGHT_LEFT[0] // 10), self.currentPos[2])
    ...
    def moveNorthWest(self, gridSize, cellSize):
        if self.currentPos[2] == Direction.TOP:
            ...
            #             print(f"COLLISION!")
            #             return
            if (0 <= (self.currentPos[0] - (constants.TURN_SMALL_FORWARD_LEFT_TOP[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_SMALL_FORWARD_LEFT_TOP[0] // 10)) * cellSize < gridSize):
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_SMALL_FORWARD_LEFT_TOP[1] // 10), self.currentPos[1] + (constants.TURN_SMALL_FORWARD_LEFT_TOP[0] // 10), self.currentPos[2])
        elif self.currentPos[2] == Direction.RIGHT:
            # for y in range(self.currentPos[1] - 1, self.currentPos[1] + 2):
            #     for obstacle in self.obstacles:
            #         i = (constants.GRID_LENGTH - constants.GRID_CELL_LENGTH - obstacle.position.x) // constants.GRID_CELL_LENGTH
            ...
            #             print(f"COLLISION!")
            #             return
            if (0 <= (self.currentPos[0] - (constants.TURN_SMALL_FORWARD_LEFT_RIGHT[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_SMALL_FORWARD_LEFT_RIGHT[0] // 10)) * cellSize < gridSize):
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_SMALL_FORWARD_LEFT_RIGHT[1] // 10), self.currentPos[1] + (constants.TURN_SMALL_FORWARD_LEFT_RIGHT[0] // 10), self.currentPos[2])
        elif self.currentPos[2] == Direction.BOTTOM:
            # for y in range(self.currentPos[1] - 1, self.currentPos[1] + 2):
            #     for obstacle in self.obstacles:
            #         i = (constants.GRID_LENGTH - constants.GRID_CELL_LENGTH - obstacle.position.x) // constants.GRID_CELL_LENGTH
            ...
            #             print(f"COLLISION!")
            #             return
            if (0 <= (self.currentPos[0] - (constants.TURN_SMALL_FORWARD_LEFT_BOTTOM[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_SMALL_FORWARD_LEFT_BOTTOM[0] // 10)) * cellSize < gridSize):
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_SMALL_FORWARD_LEFT_BOTTOM[1] // 10), self.currentPos[1] + (constants.TURN_SMALL_FORWARD_LEFT_BOTTOM[0] // 10), self.currentPos[2])
        elif self.currentPos[2] == Direction.LEFT:
            # for y in range(self.currentPos[1] - 1, self.currentPos[1] + 2):
            #     for obstacle in self.obstacles:
            #         i = (constants.GRID_LENGTH - constants.GRID_CELL_LENGTH - obstacle.position.x) // constants.GRID_CELL_LENGTH
            ...
            #             print(f"COLLISION!")
            #             return
            if (0 <= (self.currentPos[0] - (constants.TURN_SMALL_FORWARD_LEFT_LEFT[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_SMALL_FORWARD_LEFT_LEFT[0] // 10)) * cellSize < gridSize):
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_SMALL_FORWARD_LEFT_LEFT[1] // 10), self.currentPos[1] + (constants.TURN_SMALL_FORWARD_LEFT_LEFT[0] // 10), self.currentPos[2])
    ...
    def moveSouthEast(self, gridSize, cellSize):
        if self.currentPos[2] == Direction.TOP:
            ...
            #             print(f"COLLISION!")
            #             return
            if (0 <= (self.currentPos[0] - (constants.TURN_SMALL_REVERSE_RIGHT_TOP[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_SMALL_REVERSE_RIGHT_TOP[0] // 10)) * cellSize < gridSize):
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_SMALL_REVERSE_RIGHT_TOP[1] // 10), self.currentPos[1] + (constants.TURN_SMALL_REVERSE_RIGHT_TOP[0] // 10), self.currentPos[2])
        elif self.currentPos[2] == Direction.RIGHT:
            # for y in range(self.currentPos[1] - 1, self.currentPos[1] + 2):
            #     for obstacle in self.obstacles:
            #         i = (constants.GRID_LENGTH - constants.GRID_CELL_LENGTH - obstacle.position.x) // constants.GRID_CELL_LENGTH
            ...
            #             print(f"COLLISION!")
            #             return
            if (0 <= (self.currentPos[0] - (constants.TURN_SMALL_REVERSE_RIGHT_RIGHT[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_SMALL_REVERSE_RIGHT_RIGHT[0] // 10)) * cellSize < gridSize):
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_SMALL_REVERSE_RIGHT_RIGHT[1] // 10), self.currentPos[1] + (constants.TURN_SMALL_REVERSE_RIGHT_RIGHT[0] // 10), self.currentPos[2])
        elif self.currentPos[2] == Direction.BOTTOM:
            # for y in range(self.currentPos[1] - 1, self.currentPos[1] + 2):
            #     for obstacle in self.obstacles:
            #         i = (constants.GRID_LENGTH - constants.GRID_CELL_LENGTH - obstacle.position.x) // constants.GRID_CELL_LENGTH
            ...
            #             print(f"COLLISION!")
            #             return
            if (0 <= (self.currentPos[0] - (constants.TURN_SMALL_REVERSE_RIGHT_BOTTOM[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_SMALL_REVERSE_RIGHT_BOTTOM[0] // 10)) * cellSize < gridSize):
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_SMALL_REVERSE_RIGHT_BOTTOM[1] // 10), self.currentPos[1] + (constants.TURN_SMALL_REVERSE_RIGHT_BOTTOM[0] // 10), self.currentPos[2])
        elif self.currentPos[2] == Direction.LEFT:
            # for y in range(self.currentPos[1] - 1, self.currentPos[1] + 2):
            #     for obstacle in self.obstacles:
            #         i = (constants.GRID_LENGTH - constants.GRID_CELL_LENGTH - obstacle.position.x) // constants.GRID_CELL_LENGTH
            ...
            #             print(f"COLLISION!")
            #             return
            if (0 <= (self.currentPos[0] - (constants.TURN_SMALL_REVERSE_RIGHT_LEFT[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_SMALL_REVERSE_RIGHT_LEFT[0] // 10)) * cellSize < gridSize):
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_SMALL_REVERSE_RIGHT_LEFT[1] // 10), self.currentPos[1] + (constants.TURN_SMALL_REVERSE_RIGHT_LEFT[0] // 10), self.currentPos[2])
    ...
    def moveSouthWest(self, gridSize, cellSize):
        if self.currentPos[2] == Direction.TOP:
            ...
            #             print(f"COLLISION!")
            #             return
            if (0 <= (self.currentPos[0] - (constants.TURN_SMALL_REVERSE_LEFT_TOP[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_SMALL_REVERSE_LEFT_TOP[0] // 10)) * cellSize < gridSize):
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_SMALL_REVERSE_LEFT_TOP[1] // 10), self.currentPos[1] + (constants.TURN_SMALL_REVERSE_LEFT_TOP[0] // 10), self.currentPos[2])
        elif self.currentPos[2] == Direction.RIGHT:
            # for y in range(self.currentPos[1] - 1, self.currentPos[1] + 2):
            #     for obstacle in self.obstacles:
            #         i = (constants.GRID_LENGTH - constants.GRID_CELL_LENGTH - obstacle.position.x) // constants.GRID_CELL_LENGTH
            ...
            #             print(f"COLLISION!")
            #             return
            if (0 <= (self.currentPos[0] - (constants.TURN_SMALL_REVERSE_LEFT_RIGHT[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_SMALL_REVERSE_LEFT_RIGHT[0] // 10)) * cellSize < gridSize):
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_SMALL_REVERSE_LEFT_RIGHT[1] // 10), self.currentPos[1] + (constants.TURN_SMALL_REVERSE_LEFT_RIGHT[0] // 10), self.currentPos[2])
        elif self.currentPos[2] == Direction.BOTTOM:
            # for y in range(self.currentPos[1] - 1, self.currentPos[1] + 2):
            #     for obstacle in self.obstacles:
            #         i = (constants.GRID_LENGTH - constants.GRID_CELL_LENGTH - obstacle.position.x) // constants.GRID_CELL_LENGTH
            ...
            #             print(f"COLLISION!")
            #             return
            if (0 <= (self.currentPos[0] - (constants.TURN_SMALL_REVERSE_LEFT_BOTTOM[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_SMALL_REVERSE_LEFT_BOTTOM[0] // 10)) * cellSize < gridSize):
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_SMALL_REVERSE_LEFT_BOTTOM[1] // 10), self.currentPos[1] + (constants.TURN_SMALL_REVERSE_LEFT_BOTTOM[0] // 10), self.currentPos[2])
        elif self.currentPos[2] == Direction.LEFT:
            # for y in range(self.currentPos[1] - 1, self.currentPos[1] + 2):
            #     for obstacle in self.obstacles:
            #         i = (constants.GRID_LENGTH - constants.GRID_CELL_LENGTH - obstacle.position.x) // constants.GRID_CELL_LENGTH
            ...
            #             print(f"COLLISION!")
            #             return
            if (0 <= (self.currentPos[0] - (constants.TURN_SMALL_REVERSE_LEFT_LEFT[1] // 10)) * cellSize < gridSize) and (0 <= (self.currentPos[1] + (constants.TURN_SMALL_REVERSE_LEFT_LEFT[0] // 10)) * cellSize < gridSize):
                self.drawRobot(self.currentPos, cellSize, constants.GREEN,
                               constants.GREEN, constants.GREEN)
                self.bot.setCurrentPos(
                    self.currentPos[0] - (constants.TURN_SMALL_REVERSE_LEFT_LEFT[1] // 10), self.currentPos[1] + (constants.TURN_SMALL_REVERSE_LEFT_LEFT[0] // 10), self.currentPos[2])
